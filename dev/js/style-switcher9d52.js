...
jQuery(document).ready(function ($) {
    ...
    jQuery('#styleswitcher-theme-skin ul li').click(function () {
        ...
        var skin_name = $(this).find('img').attr('alt');
        $.cookie('mo_theme_skin', skin_name, { path: '/' });
        location.reload(true);

    });

    var skin_name = $.cookie('mo_theme_skin');
    if (skin_name) {
        $('link[href="css/skins/default.css"]').attr('href', 'css/skins/' + skin_name.toLowerCase() + '.css');
    }
